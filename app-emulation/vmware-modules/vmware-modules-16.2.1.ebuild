...
SRC_URI="workstation? ( https://github.com/mkubecek/vmware-host-modules/archive/refs/tags/w${PV}-k${MY_KERNEL_VERSION}.zip -> ${P}-w-${MY_KERNEL_VERSION}.zip )
	player? ( https://github.com/mkubecek/vmware-host-modules/archive//refs/tags/p${PV}-k${MY_KERNEL_VERSION}.zip -> ${P}-p-${MY_KERNEL_VERSION}.zip )"
