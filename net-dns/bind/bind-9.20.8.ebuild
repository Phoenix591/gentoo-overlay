...
IUSE="dnstap doc fixed-rrset geoip gssapi +jemalloc
...
RDEPEND="${DEPEND}
	...
	!<net-fs/samba-4.20.1
	!net-dns/bind-tools"
#For samba conflict info see Samba bug 15643 / Gentoo bug 938955
...
src_configure() {
	local myeconfargs=(
		...
		--without-cmocka
		--with-zonedb=RBTDB # new QPzone implmentation is bugged
#		$(use_enable dnsrps)
		$(use_enable dnstap)
